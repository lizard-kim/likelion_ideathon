    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_school', models.CharField(blank=True, max_length=20)),
                ('user_about', models.TextField(blank=True, max_length=100)),
                ('user_contact', models.TextField(blank=True, max_length=200)),
