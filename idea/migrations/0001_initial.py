    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('idea_subtitle', models.TextField(
                    blank=True, max_length=100, null=True)),
                ('idea_image', models.ImageField(
                    blank=True, null=True, upload_to='idea/%Y%m%d')),
                ('idea_description', models.TextField(
                    blank=True, max_length=500, null=True)),
                ('idea_hashtag', models.TextField(
                    blank=True, max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(blank=True,
                                            null=True, upload_to='idea/%Y%m%d')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('idea', models.ForeignKey(blank=True, null=True,
                                           on_delete=django.db.models.deletion.CASCADE, to='idea.Idea')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_data', models.DateTimeField(
                    default=django.utils.timezone.now)),
                ('idea_comments', models.ForeignKey(blank=True, null=True,
                                                    on_delete=django.db.models.deletion.CASCADE, to='idea.Idea_Comments')),
                ('user', models.ForeignKey(blank=True, null=True,
                                           on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
